...
- (void)tintColorDidChange {
    ...
    self.progressView.shapeLayer.strokeColor = [UIColor whiteColor].CGColor;
    self.progressView.shapeLayer.borderColor = [UIColor groupTableViewBackgroundColor].CGColor;
}
