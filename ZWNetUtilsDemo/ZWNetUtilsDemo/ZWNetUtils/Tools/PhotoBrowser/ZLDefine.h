...
//#define kViewHeight           ([[NSUserDefaults standardUserDefaults] objectForKey:@"kViewHeight"] == nil)?0:[[[NSUserDefaults standardUserDefaults] objectForKey:@"kViewHeight"] intValue]
