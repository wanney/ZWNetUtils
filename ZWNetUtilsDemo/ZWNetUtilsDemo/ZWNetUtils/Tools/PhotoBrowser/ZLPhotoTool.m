...
+ (void) saveViewHeight:(NSString *)heightStr{
    NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
    [defaults setObject:heightStr forKey:@"getViewHeight"];
    [defaults synchronize];
}

+ (NSInteger)getViewHeight{
    NSLog(@"[[NSUserDefaults standardUserDefaults] objectForKey:@\"getViewHeight\"] -> %@",[[NSUserDefaults standardUserDefaults] objectForKey:@"getViewHeight"]);
    return ([[NSUserDefaults standardUserDefaults] objectForKey:@"getViewHeight"] == nil)?0:[[[NSUserDefaults standardUserDefaults] objectForKey:@"getViewHeight"] integerValue];
}
@end
